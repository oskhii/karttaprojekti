!function(t) {
    ...
    var e = 'undefined' != typeof globalThis ?
        ...
        i = {}, n = {}, r = e && e.__generator || function(t, e) {
          var i, n, r, o, s = {
            label: 0,
            sent: function() {
              if (1 & r[0]) throw r[1];
          ...
          var e = 'function' == typeof Symbol && Symbol.iterator, i = e && t[e],
              n = 0;
        ...
        n.inorder = function t(e, i) {
          ...
          return void 0 === i && (i = !1),
                 r(this, (function(r) {
                     switch (r.label) {
                       case 0:
                         return e.value ? (n = o(a(e, i), 2), l = n[0], h = n[1],
                                           l ? [5, s(t(l, i))] : [3, 2]) :
                                          [2, void 0];
                       case 1:
                         r.sent(), r.label = 2;
    ...
    var l = {}, h = e && e.__read || function(t, e) {
      var i = 'function' == typeof Symbol && t[Symbol.iterator];
      if (!i) return t;
      var n, r, o = i.call(t), s = [];
      try {
    ...
    var p = function() {
      function t(t, e) {
        void 0 === t && (t = []), void 0 === e && (e = function(t, e) {
                                    return t < e
                                  }), this.cmp = e, this.heap = t;
        ...
        configurable: !0
             ...
             t.prototype.push = function(t) {
               for (var e = this.heap.push(t) - 1, i = !0; i;) {
                 var n = u(e);
                 n >= 0 && this.cmp(t, this.heap[n]) ? (this.swap(e, n), e = n) :
                                                       i = !1
               }
               return this.size
               ...
               var i;
               i = h([this.heap[e], this.heap[t]], 2), this.heap[t] = i[0],
               this.heap[e] = i[1]
    ...
    var d = function() {
      ...
      return Object.defineProperty(t.prototype, 'size', {
        get: function() {
          var t = 1;
          return this.left && (t += this.left.size),
                 this.right && (t += this.right.size), t
        },
        enumerable: !0,
        configurable: !0
      }),
             t.prototype.withParent =
                 function(t) {
               return this.parent = t, this
             },
             t.prototype.withoutParent =
                 function() {
             ...
             t.prototype.prettyPrintValue = function() {
               ...
               return this.right ? e += this.right.prettyPrint(t + ' │') :
                                   e += t + ' ├─── ×\n',
                      this.left ? e += this.left.prettyPrint(t + '  ') :
                                  e += t + ' └─── ×\n',
                      e
    ...
    var b = m, _ = function(t) {
      ...
      return v(e, t), e.fromArray = function(t, i, n) {
        ...
        var i = y(this.findParentAndSideFor(t), 2), n = i[0];
        ...
        if (i !== this || this.parent ||
          ...
          var s = i.parent, a = s.left === i ? 'left' : 'right';
          i.left ? (s[a] = i.left, i.left.parent = i.parent) :
                   (s[a] = i.right, i.right && (i.right.parent = i.parent))
        }
        ...
        if (i) {
          var n, r;
          if (e ? (n = 'left', r = 'rightmostDescendant') :
                  (n = 'right', r = 'leftmostDescendant'),
              i[n])
            return i[n][r].value;
          for (; i && i.parent && i.parent[n] === i;) i = i.parent;
          if (i.parent) return i.parent.value
        }
      }, e
    }(f.BinaryTree);
    c.BinarySearchTree = _;
    var w = {}, x = e && e.__extends || function() {
      var t = function(e, i) {
      ...
      return x(e, t), Object.defineProperty(e.prototype, 'color', {
        ...
        configurable: !0
             ...
             e.fromArray = function(t, i) {
               ...
               S.assert(t.right);
               var e = t.value, i = t.isRed, n = t.right;
               t.right = n.right, t.right && (t.right.parent = t),
               n.right = n.left, n.left = t.left, n.left && (n.left.parent = n),
               t.left = n, t.value = n.value, n.value = e, t.isRed = n.isRed,
               n.isRed = i
             }, e.prototype.rotateRight = function(t) {
               S.assert(t.left);
               var e = t.value, i = t.isRed, n = t.left;
               t.left = n.left, t.left && (t.left.parent = t), n.left = n.right,
               n.right = t.right, n.right && (n.right.parent = n),
               t.right = n.withParent(t), t.value = n.value, n.value = e,
               t.isRed = n.isRed, n.isRed = i
             }, e.prototype.insertFixup = function(t) {
               for (var e, i = t, n = t;
                    (null === (e = i.parent) || void 0 === e ? void 0 :
                                                               e.parent) &&
                    i.parent.isRed;) {
                 var r;
                 if (i.parent.isLeftChild)
                   (null == (r = i.parent.parent.right) ? void 0 : r.isRed) ?
                       (i.parent.isRed = !1, r.isRed = !1,
                        i.parent.parent.isRed = !0, i = i.parent.parent) :
                       (i.isRightChild &&
                            (i = i.parent, this.rotateLeft(i),
                             i.left === n && (n = i), i = i.left),
                        S.assert(i.parent), S.assert(i.parent.parent),
                        i.parent.isRed = !1, i.parent.parent.isRed = !0,
                        this.rotateRight(i.parent.parent),
                        i.parent.right === n && (n = i.parent));
                 else
                   (null == (r = i.parent.parent.left) ? void 0 : r.isRed) ?
                       (i.parent.isRed = !1, r.isRed = !1,
                        i.parent.parent.isRed = !0, i = i.parent.parent) :
                       (i.isLeftChild &&
                            (i = i.parent, this.rotateRight(i),
                             i.right === n && (n = i), i = i.right),
                        S.assert(i.parent), S.assert(i.parent.parent),
                        i.parent.isRed = !1, i.parent.parent.isRed = !0,
                        this.rotateLeft(i.parent.parent),
                        i.parent.left === n && (n = i.parent))
               }
               return this.isRed = !1, n
             }, e.prototype.insert = function(t) {
               return this.insertAndReturnNode(t), this
             }, e.prototype.insertAndReturnNode = function(t) {
               var i = R(this.findParentAndSideFor(t), 2), n = i[0], r = i[1];
               ...
               t.parent ?
                   ...
                   e &&
                       (this.isRed = e.isRed, this.value = e.value,
                        this.left = e.left, this.right = e.right,
                        e.parent = t.parent)
             }, e.prototype.deleteFixup = function(t, e) {
               for (var i, n, r, o, s, a, l, h = t, u = e; h &&
                    !(null === (i = h[u]) || void 0 === i ? void 0 : i.isRed);) {
                 var p;
                 if ('left' === u)
                   (null == (p = h.right) ? void 0 : p.isRed) &&
                       (p.isRed = !1, h.isRed = !0, this.rotateLeft(h),
                        p = (h = h.left).right),
                       S.assert(p),
                       (null === (n = p.left) || void 0 === n ? void 0 :
                                                                n.isRed) ||
                           (null === (r = p.right) || void 0 === r ? void 0 :
                                                                     r.isRed) ?
                       ((null === (o = p.right) || void 0 === o ? void 0 :
                                                                  o.isRed) ||
                            (p.left && (p.left.isRed = !1), p.isRed = !0,
                             this.rotateRight(p), p = h.right),
                        S.assert(p), p.isRed = h.isRed, h.isRed = !1,
                        p.right && (p.right.isRed = !1), this.rotateLeft(h),
                        h = void 0, this.isRed = !1) :
                       (p.isRed = !0,
                        u = (null == h ? void 0 : h.isLeftChild) ? 'left' :
                                                                   'right',
                        h = h.parent);
                 else
                   (null == (p = h.left) ? void 0 : p.isRed) &&
                       (p.isRed = !1, h.isRed = !0, this.rotateRight(h),
                        p = (h = h.right).left),
                       S.assert(p, 'w must be defined'),
                       (null === (s = p.right) || void 0 === s ? void 0 :
                                                                 s.isRed) ||
                           (null === (a = p.left) || void 0 === a ? void 0 :
                                                                    a.isRed) ?
                       ((null === (l = p.left) || void 0 === l ? void 0 :
                                                                 l.isRed) ||
                            (p.right && (p.right.isRed = !1), p.isRed = !0,
                             this.rotateLeft(p), p = h.left),
                        S.assert(p), p.isRed = h.isRed, h.isRed = !1,
                        p.left && (p.left.isRed = !1), this.rotateRight(h),
                        h = void 0, this.isRed = !1) :
                       (p.isRed = !0, u = h.isLeftChild ? 'left' : 'right',
                        h = h.parent)
               }
               if (h) {
                 var f = h[u];
               ...
               var i = this.search(t);
               if (!(i && i instanceof e)) return this;
               var n, r = i.left, o = i.right, s = i.isRed, a = i, l = a.isRed,
                      h = 'left';
               if (r)
                 if (o) {
                   if (l = (a = o.leftmostDescendant).isRed, n = a, h = 'right',
                       a.parent === i) {
                     var u = n[h];
                     u && (u.parent = a)
                   } else
                     this.transplant(a, a.right), n = a.parent, h = 'left',
                                                  a.right = o.withParent(a);
                   this.transplant(i, a),
                       i === this ?
                       (this.left = r.withParent(this),
                        a.right && (this.right = a.right.withParent(this)),
                        this.isRed = s, n === a && (n = this)) :
                       (a.left = r.withParent(a), a.isRed = s)
                 } else
                   n = i === this ? void 0 : i, h = 'left', this.transplant(i, r);
               else {
    ...
    function k(t) {
      var e = t.value.high;
      return t.left && (e = Math.max(e, t.left.value.max)),
             t.right && (e = Math.max(e, t.right.value.max)), t.value.max = e, e
    }
    var O = function() {
      function t(t) {
        void 0 === t && (t = function(t, e) {
          return t === e
        }), this.eq = t, this._size = 0, this.tree = void 0
      }
      return Object.defineProperty(t.prototype, 'size', {
        get: function() {
          return this._size
        ...
        configurable: !0
             ...
             t.prototype.insert = function(t, e, i) {
               var n = this, r = {low: t, high: e, value: i, max: e};
               if (this.tree) {
                 var o = this.tree.insertAndReturnNode(r);
                 for (o.left && k(o.left), o.right && k(o.right), k(o); o.parent;)
                   k(o.parent), o = o.parent
               } else
                 this.tree = new D.RBTree(
                     r, (function(t, e) {
                       return t.low < e.low
                     }),
                     (function(t, e) {
                       return t.low === e.low && t.high === e.high &&
                           n.eq(t.value, e.value)
                     }));
               return this._size++, this
             }, t.prototype.remove = function(t, e, i) {
               return this.tree &&
                          this.tree.remove({low: t, high: e, value: i, max: e}),
                      this
               ...
               for (var e = [], i = [this.tree]; i.length;) {
                 var n = i.pop();
                 n &&
                     (n.value.low <= t && n.value.high >= t &&
                          e.push(n.value.value),
                      n.left && n.left.value.max >= t && i.push(n.left),
                      n.right && n.value.low <= t && n.right.value.max >= t &&
                          i.push(n.right))
               }
               return e
               ...
               for (var i = [], n = [this.tree]; n.length;) {
                 var r = n.pop();
                 r &&
                     (t <= r.value.high && e >= r.value.low &&
                          i.push(r.value.value),
                      r.left && r.left.value.max >= t && n.push(r.left),
                      r.right && r.right.value.max >= t && n.push(r.right))
               }
               return i
             }, t
    }();
    ...
    function(t) {
      ...
      Object.defineProperty(t, '__esModule', {value: !0}), e(n), e(l), e(f), e(c),
          e(w), e(P)
    }(i),
    t.Timeline = t.GeoJSON.extend({
      ...
      ranges: null,
      initialize(e, n = {}) {
        this.times = [], this.ranges = new i.IntervalTree;
        t.GeoJSON.prototype.initialize.call(this, null, n),
            t.Util.setOptions(this, {drawOnSetTime: !0}),
            t.Util.setOptions(this, n),
            this.options.getInterval &&
            (this._getInterval = t => this.options.getInterval(t)),
            e && this._process(e)
      },
      _getInterval(t) {
      ...
      _process(t) {
        if (t.features.forEach((t => {
              ...
              e &&
                  (this.ranges.insert(
                       e.start + (e.startExclusive ? 1 : 0),
                       e.end - (e.endExclusive ? 1 : 0), t),
                   this.times.push(e.start), this.times.push(e.end))
            })),
            0 === this.times.length)
          return this.start = this.options.start ?? 1 / 0,
                 this.end = this.options.end ?? -1 / 0,
                 void (this.time = this.start);
      ...
      updateDisplayedLayers() {
        const t = this.ranges.lookup(this.time), e = this.getLayers(), i = [];
        e.forEach((e => {
          let n = !1;
    ...
    t.TimelineSliderControl = t.Control.extend({
      initialize(e = {}) {
        this.timelines = [], t.Util.setOptions(this, {
          duration: 1e4,
        ...
        t.Util.setOptions(this, e), this.start = e.start || 0,
        this.end = e.end || 0
      },
      _getTimes() {
        const t = [];
      ...
      _recalculate() {
        const t = void 0 !== this.options.start, e = void 0 !== this.options.end,
              i = this.options.duration;
        let n = 1 / 0, r = -1 / 0;
        this.timelines.forEach(
            (t => {t.start < n && (n = t.start), t.end > r && (r = t.end)})),
            t ||
            (this.start = n,
             this._timeSlider.min = (n === 1 / 0 ? 0 : n).toString(),
             this._timeSlider.value = this._timeSlider.min),
            e ||
            (this.end = r,
             this._timeSlider.max = (r === -1 / 0 ? 0 : r).toString()),
            this._stepSize =
                Math.max(1, (this.end - this.start) / this.options.steps),
      ...
      _rebuildDataList() {
        ...
        i.setAttribute('aria-label', 'List of times'),
            this._getTimes().forEach(
                (e => {t.DomUtil.create('option', '', i).value = e.toString()}))
      },
      _makeButton(e, i) {
      ...
      _makeButtons(t) {
        this._makeButton(t, 'prev'), this._makeButton(t, 'play'),
            this._makeButton(t, 'pause'), this._makeButton(t, 'next')
      },
      _disableMapDragging() {
      ...
      _makeSlider(e) {
        ...
        i.setAttribute('aria-label', 'Slider'),
            i.type = 'range', i.min = (this.start || 0).toString(),
            i.max = (this.end || 0).toString(),
            i.value = (this.start || 0).toString(), this._timeSlider = i,
            t.DomEvent.on(
                this._timeSlider, 'mousedown mouseup click touchstart',
                t.DomEvent.stopPropagation),
            t.DomEvent.on(
                this._timeSlider, 'change input', this._sliderChanged, this),
            t.DomEvent.on(
                this._timeSlider, 'mouseenter', this._disableMapDragging, this),
            t.DomEvent.on(
                this._timeSlider, 'mouseleave', this._enableMapDragging, this)
      },
      _makeOutput(e) {
      ...
      _sliderChanged(t) {
        const {target: e} = t,
                       i = parseFloat(
                           e instanceof HTMLInputElement ? e.value : '0');
        this._setTime(i, t.type)
      },
      _setTime(t, e) {
        this.time = t,
        this.options.waitToUpdateMap && 'change' !== e ||
            this.timelines.forEach((e => e.setTime(t))),
      ...
      addTimelines(...t) {
        ...
        t.forEach(
            (t => {-1 === this.timelines.indexOf(t) && this.timelines.push(t)})),
      ...
      play(t) {
        window.clearTimeout(this._timer),
            ...
            this._timeSlider.value =
                (parseFloat(this._timeSlider.value) + this._stepSize).toString(),
            this.setTime(+this._timeSlider.value),
            parseFloat(this._timeSlider.value) === this.end ?
            (this._playing = !1, this.container?.classList.remove('playing')) :
            (this._playing = !0, this.container?.classList.add('playing'),
             this._timer =
                 window.setTimeout((() => this.play(!0)), this._stepDuration)),
            this.syncedControl && !t && this.syncedControl.map((function(t) {
              t.play(!0)
            }))
      },
      ...
      onAdd(t) {
        return this.map = t, this._createDOM(), this.setTime(this.start),
               this.container
      },
      onRemove() {
        this.options.enableKeyboardControls && this._removeKeyListeners(),
            t.DomEvent.off(
                this._timeSlider, 'change input', this._sliderChanged, this),
            t.DomEvent.off(
                this._timeSlider, 'pointerdown mousedown touchstart',
                this._disableMapDragging, this),
            t.DomEvent.off(
                document.body, 'pointerup mouseup touchend',
                this._enableMapDragging, this),
    ...
    !function(t, e) {
      ...
      if (t && 'undefined' != typeof document) {
        ...
        r.type = 'text/css',
        'top' === i && n.firstChild ? n.insertBefore(r, n.firstChild) :
                                      n.appendChild(r),
        r.styleSheet ? r.styleSheet.cssText = t :
